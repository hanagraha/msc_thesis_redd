# -*- coding: utf-8 -*-
"""
Created on Sat Feb 15 15:09:03 2025
...
def landsat_plot(pntindex, l8):
    ...
    l8_labels = list(range(2012,2024))
    
    # Create dictionary to hold l8 data
    l8_dic = {2012 + i: (arr, meta, label) for i, (arr, meta, label) in
    ...
    for i, year in enumerate(list(range(2012,2024))):
...
app.layout = html.Div([
    ...
    html.Div([
        ...
        # Input box label
        html.Label("Enter Validation Point ID (0-779): ", style={
